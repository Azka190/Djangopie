...
function page() {
  ...
  <div className="w-full md:w-1/2 md:pl-7">
    ...
    <p className="text-[16px] pb-6 md:pb-7 pr-4 md:pr-8">Django Pie developed a mobile-first, fully responsive e-commerce website that allows users to browse GourmetGrill’s diverse range of premium dishes and place orders effortlessly. Our design focused on creating an inviting and visually rich interface, where the food takes center stage through high-quality imagery and carefully crafted product descriptions.</p>
